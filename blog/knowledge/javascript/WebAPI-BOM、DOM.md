...
# WebAPI-BOM、DOM
和标准库不同，WebAPI 是**浏览器**提供的一套 API，用于操作浏览器 窗口和界面
...
![alt text](assets/WebAPI-BOM、DOM/未标题-1.jpg)
...
<a href="https://developer.mozilla.org/zh-CN/docs/Web/API/Window/window" target="_blank">https://developer.mozilla.org/zh-CN/docs/Web/API/Window/window</a>
...
![alt text](assets/WebAPI-BOM、DOM/未标题-1-1.jpg)
...
自定义属性和元素 源码 书写是对应的，可以尝试获取 a 元素的 href 属性对比标准属性，看看有什么不同。
...
![alt text](assets/WebAPI-BOM、DOM/image.png)

![alt text](assets/WebAPI-BOM、DOM/image-1.png)

![alt text](assets/WebAPI-BOM、DOM/image-2.png)

![alt text](assets/WebAPI-BOM、DOM/image-3.png)
...
![alt text](assets/WebAPI-BOM、DOM/image-4.png)

> 上图中的 top、left、right、bottom 均相对于视口

#### 事件传播机制

![alt text](assets/WebAPI-BOM、DOM/image-5.png)
...
//   console.log(e);
// });
// btn.addEventListener("click", click2Handler);
...
// btn.removeEventListener('click', click2Handler)
```